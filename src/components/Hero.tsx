            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-slate-300 leading-relaxed max-w-2xl">
                  {t('hero.description')} <span className="text-green-400 font-semibold">{t('hero.company')}</span>, {t('hero.descriptionCont')}
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <span className="relative z-10">{t('hero.letsConnect')}</span>
               ...
               <div className="flex space-x-6 pt-4">
                <a
                  ...
                  aria-label={t('hero.viewLinkedIn')}
                >
