      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="text-gray-300 mb-8 leading-relaxed text-lg">
              Software developer, manager, and amateur pilot building the future of cloud integration.
            </p>
            <div className="flex space-x-6">
              <a
                href="https://www.linkedin.com/in/travis-harris/"
                className="group bg-gradient-to-r from-blue-600/20 to-blue-700/20 border border-white/10 p-4 rounded-2xl hover:from-blue-600/30 hover:to-blue-700/30 transition-all duration-300 transform hover:scale-110"
                target="_blank"
              ...
              <a
                ...
                className="group bg-gradient-to-r from-gray-700/20 to-gray-800/20 border border-white/10 p-4 rounded-2xl hover:from-gray-700/30 hover:to-gray-800/30 transition-all duration-300 transform hover:scale-110"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                ...
                className="group bg-gradient-to-r from-sky-600/20 to-blue-600/20 border border-white/10 p-4 rounded-2xl hover:from-sky-600/30 hover:to-blue-600/30 transition-all duration-300 transform hover:scale-110"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Bluesky profile"
              >
                <svg className="w-6 h-6 text-sky-400 group-hover:text-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 -3.268 64 68.414" fill="currentColor">
              ...
              <a
                ...
                className="group bg-gradient-to-r from-pink-600/20 to-purple-600/20 border border-white/10 p-4 rounded-2xl hover:from-pink-600/30 hover:to-purple-600/30 transition-all duration-300 transform hover:scale-110"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="border-t border-white/10 mt-16 pt-12 text-center">
          <p className="text-gray-400 text-lg">
            © {currentYear} Travis Vu. All rights reserved. Built with React and Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
