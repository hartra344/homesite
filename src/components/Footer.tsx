          ...
          <div>
            ...
            <div className="flex space-x-6">
              ...
              <a
                ...
                className="group bg-gradient-to-r from-gray-800/20 to-black/20 border border-white/10 p-4 rounded-2xl hover:from-gray-800/30 hover:to-black/30 transition-all duration-300 transform hover:scale-110"
                target="_blank"
                rel="noopener noreferrer"
              >
