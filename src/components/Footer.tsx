  ...
  return (
    <footer className="bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-10 left-10 w-72 h-72 bg-primary-500/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 right-10 w-72 h-72 bg-secondary-500/5 rounded-full blur-3xl"></div>
      </div>
          ...
          <div>
            ...
            <div className="flex space-x-6">
              <a
                ...
                className="group bg-gradient-to-r from-primary-600/20 to-secondary-700/20 border border-white/10 p-4 rounded-2xl hover:from-primary-600/30 hover:to-secondary-700/30 transition-all duration-300 transform hover:scale-110"
                target="_blank"
                rel="noopener noreferrer"
                aria-label={t('contact.social.linkedin')}
              >
                <svg className="w-6 h-6 text-primary-400 group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="group bg-gradient-to-r from-primary-600/20 to-secondary-600/20 border border-white/10 p-4 rounded-2xl hover:from-primary-600/30 hover:to-secondary-600/30 transition-all duration-300 transform hover:scale-110"
                target="_blank"
                rel="noopener noreferrer"
                aria-label={t('contact.social.bluesky')}
              >
                <svg className="w-6 h-6 text-primary-400 group-hover:text-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 -3.268 64 68.414" fill="currentColor">
              ...
              <a
                ...
                className="group bg-gradient-to-r from-secondary-600/20 to-primary-600/20 border border-white/10 p-4 rounded-2xl hover:from-secondary-600/30 hover:to-primary-600/30 transition-all duration-300 transform hover:scale-110"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram profile"
              >
                <svg className="w-6 h-6 text-secondary-400 group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a 
                  href="https://www.linkedin.com/in/travis-harris/"
                  className="text-gray-400 hover:text-primary-400 transition-all duration-300 hover:translate-x-2 inline-block py-2 px-1 min-h-[44px] flex items-center"
                  target="_blank"
                  rel="noopener noreferrer"
                >
