          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                I'm Travis, a technology leader with over a decade of experience scaling engineering teams 
                and products at Microsoft and Facebook. As Principal Software Engineering Manager for 
                Azure Logic Apps, I lead a team of 7 engineers building integration platforms that 
                serve millions of developers and handle billions of workflows globally.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                My expertise spans the full spectrum of modern web development—from TypeScript and React 
                to cloud architecture and distributed systems. But what I'm most passionate about is 
                building teams that create intuitive experiences from complex technical challenges, 
                making enterprise-grade cloud computing accessible to developers worldwide.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                Beyond the keyboard, I'm a private pilot who finds inspiration in aviation's precision 
                and safety culture, a motorcycle enthusiast who appreciates engineering excellence, 
                and a Disney World regular who values exceptional customer experiences. These interests 
                inform how I approach technology leadership—with attention to detail, user empathy, and a commitment to craft.
              </p>
            </div>
          </div>
